...
const CONTACT_OPTIONS = [
    ...
    },
    {
        ...
        link: 'https://github.com/Scynes'
    },
    {
        label: 'linkedin',
        icon: <BsLinkedin size={ '3rem' } />,
        link: 'https://linkedin.com/in/dustinjs'
    }
]
...
const Contact = () => {
    ...
    return (
        <>
            <SectionHeading label='GET IN TOUCH' heading='Contact.' />
            <Flex marginTop={ '3rem' } borderRadius={ 'lg' } bg={ useColorModeValue('gray.100', 'gray.900') } align={ 'center' } justify={ 'center' } css={ { backgroundImage: useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK), backgroundAttachment: 'fixed' } } id={ 'contact' }>
                            ...
                            <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ base: 'column', md: 'row' }}>
                                <Stack align={ 'center' } justify={ 'space-around' } direction={{ base: 'row', md: 'column' }}>
                                    { CONTACT_OPTIONS.map(( option, index ) => (
                                        <Button rounded={ 'full' } padding={ '1rem' } key={ index } as={ 'a' } cursor={ 'pointer' } aria-label={ option.label } href={ option?.link ? option.link : '#' } variant={ 'ghost' } size={ '2xl' } color={ '#804dee' }>
                                            { option.icon }
                                        </Button>
                                    )) }
                                </Stack>
